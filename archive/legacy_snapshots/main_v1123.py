...
def build_application(
    ...
    return ChatAppUI(
        assistant=assistant,
        title="Börü V0.11.2.3",
        startup_message=(
            "Börü V0.11.2.3 hazır. "
            "Mevcut güvenli tool, hafıza ve kontrollü write/edit altyapısına ek olarak "
            "basit assignment düzenlemelerinde deterministik rule-first planning, "
            "karmaşık düzenlemelerde grounded LLM fallback, strict JSON repair retry, "
            "hash-korumalı onay ve okunabilir diff çıktısı aktif."
        ),
    )
