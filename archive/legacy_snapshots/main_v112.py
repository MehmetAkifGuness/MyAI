...
def build_application(
    ...
    return ChatAppUI(
        ...
        startup_message=(
            "Börü V0.11.2 hazır. "
            "Mevcut hafıza, güvenli read-only tool sistemi, grounded synthesis, "
            "fail-closed planning ve merkezi argüman doğrulamasına ek olarak "
            "açık kullanıcı onayı gerektiren kontrollü dosya oluşturma, exact-replace düzenleme ve doğal dil komutlarından grounded diff hazırlayan hash-korumalı akıllı dosya düzenleme aktif."
        ),
    )
