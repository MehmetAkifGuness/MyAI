...
def build_application(
    ...
    return ChatAppUI(
        ...
        startup_message=(
            "Börü V0.12.1 hazır. "
            "Mevcut güvenli project-aware düzenlemeye ek olarak aynı dosyada çoklu grounded patch, "
            "çakışma doğrulaması ve bounded yerel Python dependency discovery aktif."
        ),
    )
