...
def build_application(
    ...
    return ChatAppUI(
        assistant=assistant,
        title="Börü V0.12.0.1",
        startup_message=(
            "Börü V0.12.0.1 hazır. "
            "Mevcut V0.12 project-aware düzenlemeye ek olarak pending işlemlerde "
            "fail-closed approval lock ve kullanıcı tarafından açıkça belirtilen "
            "proje dosyalarında deterministik manifest seçimi aktif."
        ),
    )
