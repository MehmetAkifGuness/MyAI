...
def build_application(
    ...
    return ChatAppUI(
        assistant=assistant,
        title="Börü V0.11.2.2",
        startup_message=(
            "Börü V0.11.2.2 hazır. "
            "Mevcut güvenli tool, hafıza ve kontrollü write/edit altyapısına ek olarak "
            "akıllı dosya düzenlemede strict JSON repair retry, grounded fail-closed planlama ve terminal-newline güvenli okunabilir diff çıktısı aktif."
        ),
    )
