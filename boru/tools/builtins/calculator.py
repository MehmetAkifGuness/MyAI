...
class CalculatorTool:
    ...
    def description(
        ...
        return (
            "Temel aritmetik ifadeleri "
            "güvenli biçimde hesaplar. "
            "Argüman: expression (metin)."
        )
    ...
    def execute(
        ...
        if (
            abs(float(value))
            > self._MAX_ABS_RESULT
        ):
            raise ValueError(
                "Hesap sonucu izin verilen "
                "sınırı aşıyor."
            )
    ...
    def _evaluate(
        ...
        if isinstance(
            ...
            if (
                ...
                raise ValueError(
                    "Yalnızca sayısal "
                    "sabitlere izin verilir."
                )

            if (
                abs(value)
                > self._MAX_ABS_LITERAL
            ):
                raise ValueError(
                    "Sayısal değer izin verilen "
                    "sınırı aşıyor."
                )
        ...
        if isinstance(
            ...
            if (
                ...
                and abs(right)
                > self._MAX_ABS_EXPONENT
            ):
                raise ValueError(
                    "Üs değeri izin verilen "
                    "sınırı aşıyor."
                )
