...
class ReleaseWorkflowTests(unittest.TestCase):
    ...
    def test_milestone_flags(self):
        with patch.object(main_v170, "build_application", return_value="app") as builder:
            for version in ("V0.27", "V0.28", "V0.29", "V1.0", "V1.1", "V1.2", "V1.3", "V1.4"):
                ...
                self.assertEqual(flags["improvement_enabled"], version in {"V0.29", "V1.0", "V1.1", "V1.2", "V1.3", "V1.4"})
                self.assertEqual(flags["general_agent_enabled"], version in {"V1.1", "V1.2", "V1.3", "V1.4"})
                self.assertEqual(flags["deep_code_index_enabled"], version in {"V1.2", "V1.3", "V1.4"})
                self.assertEqual(flags["natural_change_enabled"], version in {"V1.3", "V1.4"})
                self.assertEqual(flags["goal_driven_change_enabled"], version == "V1.4")
